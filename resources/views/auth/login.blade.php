    ...
    <div class="flex h-screen">
        ...
        <div class="hidden lg:flex items-center justify-center flex-1 bg-gray-100 text-black">
            <div class=" max-w-xl text-center">
                <img src="{{ asset('img/auth/ts-temp.png') }}" alt="Image temporal">
            </div>
        </div>
            ...
            <div class="max-w-md w-full p-6">
                ...
                <form action="{{ route('login')}}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="email" name="email" class="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300">
                    </div>
                    @error('email')
                        <x-error-alert>
                            {{ $message }}
                    ...
                    <div>
                        ...
                        <input type="password" id="password" name="password" class="mt-1 p-2 w-full border rounded-md bg-white focus:bg-white focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300">
                    </div>
                    @error('password')
                        <x-error-alert>
                            {{ $message }}
                ...
                <div class="mt-4 text-sm text-gray-600 text-center">
                    <p>You don't have an account yet ? <a wire:navigate href="{{route('register')}}" class="text-black hover:underline">Sing Up</a></p>
                </div>
            </div>
        </div>
    </div>
